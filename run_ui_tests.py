...
def run_quick_ui_check(args):
    ...
    cmd = [
        ...
        'ui_tests/', '-m', 'critical', '-v', '--tb=short'
    ]
...
Examples:
  ...
  %(prog)s --report --all-browsers          # Generate cross-browser report
    ...
    test_group.add_argument('--all', action='store_true',
                           help='Run all UI tests')
    test_group.add_argument('--quick', action='store_true',
                           help='Run quick smoke tests only')
    test_group.add_argument('--registration', action='store_true',
                           help='Run registration UI tests')
    test_group.add_argument('--schedule', action='store_true',
                           help='Run schedule UI tests')
    test_group.add_argument('--polls', action='store_true',
                           help='Run polls UI tests')
    test_group.add_argument('--debug', action='store_true',
                           help='Run in debug mode (headed browser, verbose output)')
    test_group.add_argument('--report', action='store_true',
                           help='Generate comprehensive test report')
    
    # Test filtering
    parser.add_argument('-k', '--test-pattern', 
                       help='Run tests matching this pattern')
    parser.add_argument('-m', '--marker',
                       help='Run tests with this marker (ui, critical, smoke)')
    ...
    parser.add_argument('--port', type=int, default=5000,
                       help='Port for test Flask server')
    parser.add_argument('--database-url',
                       help='Test database URL (optional)')
    ...
    parser.add_argument('--screenshot-dir', default='ui_tests/screenshots',
                       help='Directory for failure screenshots')
    
    # Report generation
    parser.add_argument('--report-dir', default='ui_test_reports',
    ...
    parser.add_argument('--check-setup', action='store_true',
                       help='Check UI test setup and exit')
