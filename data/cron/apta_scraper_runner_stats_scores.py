...
def run_step(description, command):
    ...
    try:
        ...
        sms_message = f"🔄 APTA Stats/Scores Scraper\n\n{success_message}"
...
def main():
    ...
    start_message = f"🚀 APTA Stats/Scores Scraper Started\n\nTime: {start_time.strftime('%Y-%m-%d %H:%M:%S')}\nLeague: APTA_CHICAGO\n\nScraping and importing APTA match scores and stats only..."
    print(f"\n=== {start_message} ===")
    ...
    try:
        ...
        error_message = f"💥 APTA Stats/Scores Scraper Failed!\n\nTotal Duration: {total_duration_formatted}\nLeague: APTA_CHICAGO\nError: {str(e)}"
        print(f"\n=== {error_message} ===")
