...
def run_step(description, command):
    ...
    try:
        ...
        sms_message = f"🔄 APTA PTI Player Import\n\n{success_message}"
...
def main():
    ...
    start_message = f"🚀 APTA PTI Player Import Started\n\nTime: {start_time.strftime('%Y-%m-%d %H:%M:%S')}\nLeague: APTA_CHICAGO\n\nScraping and importing PTI player data only..."
    print(f"\n=== {start_message} ===")
    ...
    try:
        ...
        error_message = f"💥 APTA PTI Player Import Failed!\n\nTotal Duration: {total_duration_formatted}\nLeague: APTA_CHICAGO\nError: {str(e)}"
        print(f"\n=== {error_message} ===")
