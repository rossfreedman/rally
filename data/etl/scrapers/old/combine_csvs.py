...
def combine_csv_files():
    try:
        ...
        csv_files = [f for f in all_files if f.endswith('.csv') and f.startswith('Series ')]
        ...
        combined_df['sort_key'] = combined_df['Series'].apply(lambda x: get_series_number(x))
        ...
        combined_df = combined_df.sort_values(['sort_key', 'Last Name'], ascending=[False, True])
        combined_df = combined_df.drop('sort_key', axis=1)  # Remove the temporary sort column
