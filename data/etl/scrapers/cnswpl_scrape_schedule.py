            ...
            try:
                ...
                if series_link and series_link.text:
                    ...
                    if series_number.startswith("Series "):
                        ...
                        # Add "Series " prefix to match players.json format
                        # This handles: "SN" -> "Series SN", "1" -> "Series 1", "2B" -> "Series 2B", etc.
                    ...
                    for entry in schedule_entries:
                        ...
                        if all([date, match_time, home, away]):  # Only require core fields
                            # Get raw team names from the website
                            ...
                            # Use team names as-is from the website (they already have correct format)
                            ...
                            schedule_item = {
                                ...
                                "home_team": formatted_away,  # CNSWPL website lists away team first
                                "away_team": formatted_home,  # CNSWPL website lists home team second
