...
--
-- Name: group_members uc_unique_group_member; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.group_members
    ADD CONSTRAINT uc_unique_group_member UNIQUE (group_id, user_id);
...
--
-- Name: idx_group_members_added_by; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_group_members_added_by ON public.group_members USING btree (added_by_user_id);
...
--
-- Name: group_members fk_group_members_added_by_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.group_members
    ADD CONSTRAINT fk_group_members_added_by_user_id FOREIGN KEY (added_by_user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: group_members fk_group_members_group_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: group_members fk_group_members_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: groups fk_groups_creator_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.groups
    ADD CONSTRAINT fk_groups_creator_user_id FOREIGN KEY (creator_user_id) REFERENCES public.users(id) ON DELETE CASCADE;
