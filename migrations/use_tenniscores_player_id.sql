...
RAISE NOTICE 'Step 1 COMPLETED: Created backup table';
...
RAISE NOTICE 'Step 2 COMPLETED: Added new columns';
...
RAISE NOTICE 'Step 3 COMPLETED: Populated new columns';
...
RAISE NOTICE 'Step 5 COMPLETED: Set NOT NULL constraints';
...
RAISE NOTICE 'Step 6 COMPLETED: Dropped old constraints and indexes';
...
RAISE NOTICE 'Step 7 COMPLETED: Created new primary key and foreign key constraints';
...
RAISE NOTICE 'Step 8 COMPLETED: Created new indexes';

-- Step 9: Remove old player_id column
ALTER TABLE user_player_associations
DROP COLUMN player_id;

RAISE NOTICE 'Step 9 COMPLETED: Removed old player_id column';
...
-- COMMIT;
-- 
-- Note: This will lose any associations created after the migration 