...
def upgrade():
    ...
    with get_db() as conn:
        ...
        try:
            ...
            """)
            print("✅ Enhanced constraint added: (tenniscores_player_id, league_id, club_id, series_id)")
            ...
            print("🔧 Players can now exist in multiple clubs/series with same Player ID")
