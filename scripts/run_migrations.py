...
def run_legacy_migrations():
    ...
    try:
        from migrations.add_missing_user_columns import (
            run_migration as run_columns_migration,
        )
        from migrations.create_leagues_tables import (
            run_migration as run_leagues_migration,
        )
