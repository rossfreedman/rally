        ...
        for member in team_members:
            ...
            if user_league_id:
                ...
                if league_id_int:
                    ...
                    filtered_count = (
                        filtered_matches["match_count"] if filtered_matches else 0
                    )
            ...
            print(
                f"   Total: {total_count}, Filtered: {filtered_count}, League: {user_league_id}"
            )
            ...
            if total_count == 0:
                ...
                issues_found.append(
                    f"{player_name}: Filtered count ({filtered_count}) differs from total ({total_count})"
                )
