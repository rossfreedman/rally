...
def fix_player_club_series(
    player_id="nndz-WkMrK3didjlnUT09", club_name="Tennaqua", series_name="Chicago 22"
):
    ...
    try:
        ...
        if has_player_leagues:
            ...
            """
            existing_row = execute_query_one(
                check_row_query, [player["id"], player["league_id"]]
            )
            ...
            if existing_row:
                ...
                execute_update(
                    update_leagues_query,
                    [club_id, series_id, player["id"], player["league_id"]],
                )
                ...
                execute_update(
                    insert_leagues_query,
                    [player["id"], player["league_id"], club_id, series_id],
                )
