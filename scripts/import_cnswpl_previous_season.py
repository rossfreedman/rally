"""
Import CNSWPL previous season match history data into match_scores_previous_seasons table.

This script imports data from data/leagues/CNSWPL/cnswpl_match_history_2024_2025.json
...
def parse_match_date(date_str):
    ...
    if not date_str:
        return None
    try:
        # Handle DD-Mon-YY format like "06-Mar-25"
...
def import_match_record(cur, match_data, league_id, season):
    ...
    # Extract match data with safe null handling
    ...
    try:
        ...
        # Most common cause: foreign key constraint on team_id (team doesn't exist)
...
def main():
    ...
    print("=" * 80)
    print("IMPORTING CNSWPL PREVIOUS SEASON MATCH HISTORY (2024-2025)")
    print("=" * 80)
    
    # Configuration
    json_file = "data/leagues/CNSWPL/cnswpl_match_history_2024_2025.json"
    league_identifier = "CNSWPL"
    season = "2024-2025"
