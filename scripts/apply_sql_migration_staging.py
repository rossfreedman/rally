#!/usr/bin/env python3
"""
Apply SQL Migration Directly to Staging
========================================

This script applies the food and videos table changes directly to staging.
"""
...
def main():
    print("=" * 70)
    print("🚀 Applying Database Changes to Staging")
    print("=" * 70)
    print()
    
    # Confirm execution
    response = input("🔄 Apply changes to STAGING database? [y/N]: ").strip().lower()
    ...
    try:
        ...
        conn = psycopg2.connect('postgresql://postgres:SNDcbFXgqCOkjBRzAzqGbdRvyhftepsY@switchback.proxy.rlwy.net:28473/railway')
...
if __name__ == "__main__":
    ...
    if success:
        print("=" * 70)
        print("✅ SUCCESS - All database changes applied to staging!")
        print("=" * 70)
        print()
        print("📝 Summary:")
