...
def migrate_user_player_associations_with_mapping(local_conn, railway_conn, player_mapping):
    ...
    for local_user_id, local_player_id, is_primary, created_at, user_email in local_associations:
        # Map user ID
        ...
        try:
            ...
            print(f"    ✅ Migrated: {user_email} -> Player ID {railway_player_id}{primary_text}")
    ...
    try:
        ...
        with get_db() as local_conn:
            ...
            try:
                ...
                ph_count = migrate_player_history_with_mapping(local_conn, railway_conn, player_mapping)
                
                # Migrate user_player_associations with mapping
                upa_count = migrate_user_player_associations_with_mapping(local_conn, railway_conn, player_mapping)
