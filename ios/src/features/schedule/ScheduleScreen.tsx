...
export const ScheduleScreen: React.FC<ScheduleScreenProps> = ({
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <TopBar onMenuPress={handleMenuPress} onDownloadPress={onDownloadPress} />
      ...
      <MenuDrawer
        ...
        selectedItemId={activeTab === 'availability' ? 'availability' : undefined}
...
const styles = StyleSheet.create({
  ...
  scrollView: {
    flex: 1,
    paddingTop: 147, // Account for fixed TopBar height
  },
  scrollContent: {
