...
def get_lineup_escrow_analytics():
    """Get analytics for lineup escrow usage."""
    try:
        # Get total escrow sessions
        total_sessions = execute_query_one("""
        ...
        saved_lineups_stats = execute_query_one("""
        ...
        print(f"Error getting lineup escrow analytics: {e}")
        return None
