...
def debug_availability_update():
    ...
    try:
        ...
        if existing_record:
            print(f"✅ Found existing record: ID={existing_record['id']}, Status={existing_record['availability_status']}")
            ...
            if earlier_record:
                print(f"🔧 Found discrepant record one day earlier: ID={earlier_record['id']}")
        ...
        if verification_record:
            ...
            if all_records:
                for record in all_records:
                    print(f"   ID={record['id']}, Date={record['match_date']}, UTC Date={record['utc_date']}, Status={record['availability_status']}")
            else:
