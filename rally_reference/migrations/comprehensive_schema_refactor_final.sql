-- ================================================================
-- Rally Database Schema Comprehensive Refactoring Migration (FINAL)
-- ================================================================
-- 
...
ALTER TABLE players DROP COLUMN IF EXISTS club_automation_password;
ALTER TABLE players DROP COLUMN IF EXISTS is_admin;
ALTER TABLE players DROP COLUMN IF EXISTS last_login;
...
-- Step 3.4: Update NOT NULL constraints for required fields (only if players exist)
-- Since we cleared the table, these constraints will work
ALTER TABLE players 
ALTER COLUMN first_name SET NOT NULL,
ALTER COLUMN last_name SET NOT NULL;

-- Note: We'll set these constraints after importing data
...
ALTER TABLE users DROP COLUMN IF EXISTS series_id;
ALTER TABLE users DROP COLUMN IF EXISTS league_id;
ALTER TABLE users DROP COLUMN IF EXISTS tenniscores_player_id;
...
-- Split the ALTER TABLE operations
ALTER TABLE match_scores DROP COLUMN IF EXISTS league_id;
ALTER TABLE match_scores RENAME COLUMN new_league_id TO league_id;
...
-- Split the ALTER TABLE operations
ALTER TABLE player_history DROP COLUMN IF EXISTS league_id;
ALTER TABLE player_history DROP COLUMN IF EXISTS player_id;
ALTER TABLE player_history RENAME COLUMN new_league_id TO league_id;
ALTER TABLE player_history RENAME COLUMN new_player_id TO player_id;
...
-- Split the ALTER TABLE operations
ALTER TABLE schedule DROP COLUMN IF EXISTS league_id;
ALTER TABLE schedule RENAME COLUMN new_league_id TO league_id;
...
-- Split the ALTER TABLE operations
ALTER TABLE series_stats DROP COLUMN IF EXISTS league_id;
ALTER TABLE series_stats RENAME COLUMN new_league_id TO league_id;
...
-- Split the ALTER TABLE operations
ALTER TABLE player_availability DROP COLUMN IF EXISTS tenniscores_player_id;
ALTER TABLE player_availability RENAME COLUMN new_player_id TO player_id;
...
-- Handle email constraint and index properly
-- Drop the constraint first, then the index will be automatically dropped
ALTER TABLE players DROP CONSTRAINT IF EXISTS users_email_key;
-- Create new unique index for email (allowing NULL values)
