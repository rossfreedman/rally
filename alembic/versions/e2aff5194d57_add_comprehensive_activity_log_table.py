...
def upgrade() -> None:
    ...
    op.alter_column(
        "player_availability", "player_id", existing_type=sa.INTEGER(), nullable=True
    )
    op.alter_column(
        "player_availability",
        "notes",
    ...
    op.drop_index(
        "idx_player_availability_notes",
        table_name="player_availability",
        postgresql_using="gin",
        postgresql_where="((notes IS NOT NULL) AND (notes <> ''::text))",
    )
    ...
    op.drop_index(
        "idx_player_season_tracking_league_season", table_name="player_season_tracking"
    )
    op.drop_index(
        "idx_player_season_tracking_player_id", table_name="player_season_tracking"
    )
    op.drop_constraint(
        "player_season_tracking_player_id_league_id_season_year_key",
        "player_season_tracking",
        type_="unique",
    )
    op.create_unique_constraint(
        "unique_player_season_tracking",
        "player_season_tracking",
        ["player_id", "league_id", "season_year"],
    )
    ...
    op.drop_index(
        "idx_teams_active", table_name="teams", postgresql_where="(is_active = true)"
    )
    ...
    op.drop_index(
        "idx_teams_team_alias",
        table_name="teams",
        postgresql_where="(team_alias IS NOT NULL)",
    )
    op.drop_constraint("teams_club_id_series_id_league_id_key", "teams", type_="unique")
    op.create_unique_constraint(
        "unique_team_club_series_league", "teams", ["club_id", "series_id", "league_id"]
    )
    op.drop_table_comment(
        "teams",
...
def downgrade() -> None:
    ...
    op.create_index(
        "idx_user_instructions_team_id", "user_instructions", ["team_id"], unique=False
    )
    op.alter_column(
        "user_instructions",
        "team_id",
    ...
    op.create_unique_constraint(
        "teams_club_id_series_id_league_id_key",
        "teams",
    ...
    op.create_index(
        "idx_series_stats_team_id", "series_stats", ["team_id"], unique=False
    )
    op.alter_column(
        "series_stats",
        "team_id",
    ...
    op.create_index(
        "idx_schedule_home_team_id", "schedule", ["home_team_id"], unique=False
    )
    op.create_index(
        "idx_schedule_away_team_id", "schedule", ["away_team_id"], unique=False
    )
    op.alter_column(
        "schedule",
        "away_team_id",
    ...
    op.drop_constraint(
        "unique_player_season_tracking", "player_season_tracking", type_="unique"
    )
    op.create_unique_constraint(
        "player_season_tracking_player_id_league_id_season_year_key",
        "player_season_tracking",
    ...
    op.create_index(
        "idx_player_season_tracking_player_id",
        "player_season_tracking",
        ["player_id"],
        unique=False,
    )
    op.create_index(
        "idx_player_season_tracking_league_season",
        "player_season_tracking",
    ...
    op.create_index(
        ...
        "player_availability",
        ["player_id", "match_date", "series_id"],
        unique=True,
    )
    op.create_index(
    ...
    op.create_index(
        "idx_player_availability_notes",
        "player_availability",
        [sa.literal_column("to_tsvector('english'::regconfig, notes)")],
        unique=False,
        postgresql_using="gin",
        postgresql_where="((notes IS NOT NULL) AND (notes <> ''::text))",
    )
    ...
    op.alter_column(
        "player_availability", "player_id", existing_type=sa.INTEGER(), nullable=False
    )
    op.create_index(
        "idx_match_scores_home_team_id", "match_scores", ["home_team_id"], unique=False
    )
    op.create_index(
        "idx_match_scores_away_team_id", "match_scores", ["away_team_id"], unique=False
    )
    op.alter_column(
        "match_scores",
        "away_team_id",
