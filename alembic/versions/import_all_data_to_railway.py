...
def upgrade():
    ...
    if final_matches > 5000 and final_ph > 100000 and final_upa > 0:
        ...
        print(
            f"🌐 Your application should now be fully functional at: https://www.lovetorally.com"
        )
...
def downgrade():
    ...
    print(
        "✅ All imported data removed (including match_scores, schedule, series_stats, player_availability)"
    )
